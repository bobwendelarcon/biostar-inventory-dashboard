...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (btnSaveCategory) {
        btnSaveCategory.addEventListener("click", async function () {
            const isEdit = categoryMode.value === "edit";
            ...
            if (isEdit) {
                payload.catg_id = catgId.value.trim();
            }

            if (!payload.catg_name) {
                alert("Category Name is required.");
                return;
            }

            try {
                const url = isEdit ? "/Categories/UpdateCategory" : "/Categories/AddCategory";
